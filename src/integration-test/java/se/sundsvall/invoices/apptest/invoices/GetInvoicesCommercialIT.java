...
class GetInvoicesCommercialIT extends AbstractAppTest {
	...
	void test01_getInvoicesOnlyRequired() {
		setupCall()
			.withServicePath("/commercial?partyId=AC653C32-B26C-47E8-8C2E-3B18C1B5879C")
			.withHttpMethod(GET)
	...
	void test02_getInvoicesAllAttributes() {
		setupCall()
			.withServicePath("/commercial?partyId=EC114D35-A46C-48EF-599E-7E32B5B5939C" +
				"&page=1" +
				"&limit=100" +
	...
	void test03_customerWithNoEngagements() {
		setupCall()
			.withServicePath("/commercial?partyId=EC114D35-A46C-48EF-599E-7E32B5B5939D")
			.withHttpMethod(GET)
	...
	void test05_getInvoicesForMultipleFacilityIds() {
		setupCall()
			.withServicePath("/commercial?partyId=AC653C32-B26C-47E8-8C2E-4D18C1B5879C" +
