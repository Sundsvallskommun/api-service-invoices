...
class GetInvoicesPublicAdministrationIT extends AbstractAppTest {
	...
	void test01_getInvoicesOnlyRequired() {
		setupCall()
			.withServicePath("/2281/public_administration?partyId=AC653C32-B26C-47E8-8C2E-3B18C1B5879C")
			.withHttpMethod(GET)
	...
	void test02_getInvoicesAllAttributes() {
		setupCall()
			.withServicePath("/2281/public_administration?partyId=EC114D35-A46C-48EF-599E-7E32B5B5939C" +
				"&page=1" +
				"&limit=100" +
	...
	void test03_getInvoicesForMultiplePartyIds() {
		setupCall()
			.withServicePath("/2281/public_administration?partyId=88c8c596-e545-4c42-aa2f-2f61a150613b&partyId=5256b101-4df3-4990-8ac8-6e49478bde4f")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
